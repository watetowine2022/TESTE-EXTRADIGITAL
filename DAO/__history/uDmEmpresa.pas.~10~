...
begin
  ...
  begin
    ...
    Params[4].AsDate := strtodate(DTCadastro);
    Params[5].Asdate := strtodate(DTAbertura);
    ...
    Params[11].Asdate := strtodate(DTExcluido);
  ...
  try
    ...
    begin
      ...
      begin
        ...
        SAtivo       := FieldByName('STAtivo').AsString;
...
begin
  ...
  begin
    ...
    Except on E: Exception do
      begin
        sErro := 'Erro ao excluir a Empresa' + E.Message;
        Result := false;
      end;
